...
const App = () => { 
    ...
    <div class="otree-body container">
        ...
        <form class="otree-form" method="post" role="form" id="form" autocomplete="off">
            <input type="hidden" name="csrfmiddlewaretoken" value="XrBNGM0QHb1P0dLEcfI6CvA1kS0W00m4lCGX2TyZ5pw9QgVqQmVUh67lbtpEdcLs"/>
            <div class="_otree-content">
                ...
                <div class="form-group required">
                    <label class="col-form-label" for="id_age">What is your age?</label>
